...
const mockActiveLoans = [
  {
    id: 'loan_001',
    loanId: 'DFL-2026-001',
    loanName: 'Personal Development Loan',
    status: 'Active',
    totalAmount: 5000,
    paidAmount: 2000,
    ...
    nextPaymentDue: '2026-01-15T00:00:00',
  },
  {
    id: 'loan_002',
    loanId: 'DFL-2026-002',
    ...
    nextPaymentDue: '2026-01-20T00:00:00',
  },
];
...
const mockPaymentHistory = [
  {
    ...
    status: 'Completed',
    txHash: '0x742d35Cc6634C0532925a3b844Bc9e7595f0bEb8A1c9D4e3F2a1B0c9D8e7F6a5',
  },
  {
    id: 'pay_002',
    date: '11/28/2025',
    ...
    type: 'Principal + Interest',
    status: 'Completed',
    txHash: '0x8e7F6a5B4c3D2e1F0a9B8c7D6e5F4a3B2c1D0e9F8a7B6c5D4e3F2a1B0c9D8e7',
  },
];
...
const mockRecommendations = [
  {
    id: 'rec_001',
    title: 'Make Early Payments',
    description: 'Pay your next installment 5 days early to demonstrate reliability and improve your payment history score.',
    impact: 'High',
  ...
  },
  {
    ...
    description: 'Paying down 20% of your remaining balance will significantly improve your credit utilization ratio.',
    impact: 'High',
  ...
  },
  {
    ...
    description: 'You have 4 consecutive on-time payments. Continue this streak to boost your reliability score.',
    impact: 'Medium',
    ...
    <div className="min-h-screen bg-background pt-16">
      <div className="max-w-7xl mx-auto px-4 md:px-6 lg:px-8 py-6 md:py-8 lg:py-12">
        <div className="mb-6 md:mb-8 lg:mb-12">
          <div className="flex items-start justify-between mb-4">
            <div>
              ...
              <p className="text-sm md:text-base text-muted-foreground">
                Manage your loans and track your credit journey
              </p>
            </div>
          ...
          <QuickActionsPanel
            onBrowseLoans={handleBrowseLoans}
            onMakePayment={() => handleMakePayment(mockActiveLoans[0])}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 md:gap-6 lg:gap-8 mb-6 md:mb-8 lg:mb-12">
          <div className="lg:col-span-1">
            <CreditScoreCard
              creditScore={mockCreditData.score}
              rating={mockCreditData.rating}
              trend={mockCreditData.trend}
          ...
          <div className="lg:col-span-2 space-y-4 md:space-y-6">
            <div className="flex items-center justify-between mb-4">
              ...
              <span className="px-3 py-1 bg-primary/10 text-primary rounded-full text-xs md:text-sm font-medium">
                {mockActiveLoans.length} Active
              </span>
            </div>
            {mockActiveLoans.map((loan) => (
              <ActiveLoanCard key={loan.id} loan={loan} onMakePayment={handleMakePayment} />
            ))}
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 md:gap-6 lg:gap-8 mb-6 md:mb-8 lg:mb-12">
          <div className="lg:col-span-1">
            <UpcomingPaymentsWidget payments={mockUpcomingPayments} onPayNow={handlePayNow} />
          </div>

          <div className="lg:col-span-2">
            <ImprovementRecommendations recommendations={mockRecommendations} />
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-4 lg:gap-6">
          <div className="p-4 md:p-6 bg-card border border-border rounded-xl">
            <div className="flex items-center gap-3 mb-3">
              <div className="w-10 h-10 md:w-12 md:h-12 flex items-center justify-center rounded-lg bg-primary/10">
                <AppIcon name="DollarSign" size={20} className="text-primary" />
              </div>
              <div className="flex-1 min-w-0">
                <div className="text-xs text-muted-foreground mb-1">Total Borrowed</div>
                <div className="text-lg md:text-xl lg:text-2xl font-bold text-foreground">$15,000</div>
              </div>
            </div>
          </div>
          ...
          <div className="p-4 md:p-6 bg-card border border-border rounded-xl">
            <div className="flex items-center gap-3 mb-3">
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="text-lg md:text-xl lg:text-2xl font-bold text-foreground">$5,500</div>
              </div>
            </div>
          </div>
          ...
          <div className="p-4 md:p-6 bg-card border border-border rounded-xl">
            <div className="flex items-center gap-3 mb-3">
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="text-lg md:text-xl lg:text-2xl font-bold text-foreground">$9,500</div>
              </div>
            </div>
          </div>
          ...
          <div className="p-4 md:p-6 bg-card border border-border rounded-xl">
            <div className="flex items-center gap-3 mb-3">
              <div className="w-10 h-10 md:w-12 md:h-12 flex items-center justify-center rounded-lg bg-accent/10">
                <AppIcon name="TrendingUp" size={20} className="text-accent" />
              </div>
              <div className="flex-1 min-w-0">
                <div className="text-xs text-muted-foreground mb-1">On-Time Rate</div>
                <div className="text-lg md:text-xl lg:text-2xl font-bold text-foreground">100%</div>
              </div>
            </div>
          </div>
        </div>
